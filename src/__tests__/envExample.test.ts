...
const REQUIRED_ENV_KEYS = [
  ...
  "DOC_PARSER_MAX_MARKDOWN_CHARS",
  "DOC_PARSER_MAX_FILE_BYTES",
  "DOC_PARSER_MAX_PDF_PAGES",
  "DOC_PARSER_MAX_ARCHIVE_ENTRIES",
  "DOC_PARSER_MAX_ARCHIVE_BYTES",
  "DOC_PARSER_MAX_COMPRESSION_RATIO",
